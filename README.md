...
4. **Configure Storage Location**: Access Settings to change the folder name for GPX files (default: `GPXLogger`). The full storage path is displayed in settings along with accessibility status.
5. **GPX Files**: Files are automatically saved to the public Downloads folder (`Downloads/<folder>/`) with timestamp-based filenames (e.g., `20260131-123407.gpx`). This location is accessible via standard file browsers.
